...
void main(List<String> argsIn) {  
  ...
  //argsFull.setDebugArgs("create app --package-name eval_example --package-code evex --project-style app-eval-demo --auto-install true");
  //argsFull.setDebugArgs("create app --package-name tutorial_eval --package-code eval --project-style app-eval-demo --auto-install true --local-afib /Users/chrisjones/projects/afib");
