...
void main(List<String> argsIn) {  
  ...
  argsFull.setDebugArgs("create app --package-name warning_test --package-code wt --project-style app-starter-minimal --cwd /Users/chrisjones/projects/afib/temp/warning_test");
