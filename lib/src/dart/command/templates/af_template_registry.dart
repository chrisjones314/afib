...
import 'package:afib/src/dart/command/templates/files/default_theme.t.dart';
...
import 'package:afib/src/dart/command/templates/files/extend_base_third_party.t.dart';
import 'package:afib/src/dart/command/templates/files/extend_command.t.dart';
import 'package:afib/src/dart/command/templates/files/extend_command_third_party.t.dart';
import 'package:afib/src/dart/command/templates/files/extend_test.t.dart';
import 'package:afib/src/dart/command/templates/files/extend_third_party.t.dart';
import 'package:afib/src/dart/command/templates/files/fundamental_theme.t.dart';
...
import 'package:afib/src/dart/command/templates/files/screen_map.t.dart';
...
class AFTemplateRegistry {
  ...
  AFTemplateRegistry() {
    ...
    register(AFUISourceTemplateID.fileExtendBaseThirdParty, AFExtendBaseThirdPartyT());
    register(AFUISourceTemplateID.fileExtendCommand, AFExtendCommandT());
    register(AFUISourceTemplateID.fileExtendCommandThirdParty, AFExtendCommandThirdPartyT());
    register(AFUISourceTemplateID.fileExtendThirdParty, AFExtendThirdPartyT());
    ...
    register(AFUISourceTemplateID.fileDefaultTheme, AFDefaultThemeT());
    register(AFUISourceTemplateID.fileExtendTest, AFExtendTestT());
    register(AFUISourceTemplateID.fileScreenMap, AFScreenMapT());
    register(AFUISourceTemplateID.fileFundamentalTheme, AFFundamentalThemeT());
