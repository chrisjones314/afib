...
import 'package:[!af_package_path]/initialization/extend/extend_third_party.g.dart';
  ...
  group("AFib Test", () {
    testWidgets('Afib Test', (tester) async {
      ...
      await afTestWidgetStartup(paramsD, tester, () async {
          ...
          await afTestMain<[!af_app_namespace(upper)]State>(extendBase, extendBaseThirdParty, extendApp, extendThirdParty, extendTest, paramsD, tester);
        });
      });
  });
}
