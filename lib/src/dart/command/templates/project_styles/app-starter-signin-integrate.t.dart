...
generate query WriteOneUserQuery --result-type User --member-variables "User user" --override-templates "core/files/query_simple=project_styles/$insertProjectStyle/files/query_write_user"
generate query ReadUserQuery --result-type User --member-variables "String credentialUserId" --override-templates "core/files/query_simple=project_styles/$insertProjectStyle/files/query_read_user"
