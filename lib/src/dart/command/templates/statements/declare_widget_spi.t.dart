...
class [!af_screen_name]SPI extends [!af_spi_parent_type]<[!af_state_view_type], [!af_screen_name]RouteParam> {
  ...
  factory [!af_screen_name]SPI.create(AFBuildContext<[!af_state_view_type], [!af_screen_name]RouteParam> ctx, [!af_theme_type] theme, AFScreenID screenId, AFID wid, AFWidgetParamSource paramSource) {
    return [!af_screen_name]SPI(ctx, screenId, wid, paramSource, theme);
  }  
