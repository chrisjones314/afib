...
class [!af_screen_name]SPI extends [!af_spi_parent_type]<[!af_state_view_type], [!af_screen_name]RouteParam> {
  [!af_screen_name]SPI(AFBuildContext<[!af_state_view_type], [!af_screen_name]RouteParam> context, AFScreenID screenId, AFID wid, AFWidgetParamSource paramSource, [!af_theme_type] theme): super(context, standard);
