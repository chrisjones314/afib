...
@immutable
class AFUIPrototypeDialogRouteParam extends AFRouteParam {
  ...
  }): super(id: AFUIScreenID.screenPrototypeDialog);
...
class AFUIPrototypeDialogScreen extends AFUIConnectedScreen<AFUIPrototypeDialogScreenSPI, AFUIDefaultStateView, AFUIPrototypeDialogRouteParam>{
  ...
  static AFNavigateAction navigatePush(AFDialogPrototype test, {AFID? id}) {
    return AFNavigatePushAction(
      id: id,
      routeParam: AFUIPrototypeDialogRouteParam(test: test, routeParam: AFRouteParamUnused.create(id: AFUIScreenID.screenPrototypeDialog)),
    );
  }
  ...
  Widget _createScaffold(AFUIPrototypeDialogScreenSPI spi, Widget resultWidget) {
    ...
    return t.childScaffold(
      spi: spi,
      appBar: AppBar(title: t.childText('Dialog Test Screen')),
      body: resultWidget,
    );
